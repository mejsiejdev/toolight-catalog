...
import './styles/menuMobileToggle.scss';

const MenuMobileToggle = ({ onToggle, isToggled }) => {
  return (
    <>
      <div className="navbar__toggle">
        <div onClick={onToggle} className="navbar-toggle">
          <svg
            viewBox="0 0 32 42"
            xmlns="http://www.w3.org/2000/svg"
            className={`toggle-icon ${isToggled && `active`}`}
          >

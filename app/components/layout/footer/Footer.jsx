        ...
        <section className="footer">
          <div className="footer-column">
            ...
            <p className="company-description">
              ...
              Accusamus aperiam dolore doloremque eligendi esse eum ex neque
              saepe sit tempore! Amet corporis culpa ducimus eum exercitationem
              fuga praesentium provident quo.
            </p>
          </div>
          <div className="footer-column">
